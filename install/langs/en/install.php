...
return array(
	...
	'translations' => array(
		...
		'You are using PHP %s version. Soon, the latest PHP version supported by Defenix HMS will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!' => 'You are using PHP %s version. Soon, the latest PHP version supported by Defenix HMS will be PHP 8.1. To make sure you’re ready for the future, we recommend you to upgrade to PHP 8.1 now!',
		...
		'Yes' => 'Yes',
		'No' => 'No',
		'Installing demo data is a good way to learn how to use Defenix HMS if you have not used it before. This demo data can later be erased using module Defenix HMS Data Cleaner which comes pre-installed with this installation.' => 'Installing demo data is a good way to learn how to use Defenix HMS if you have not used it before. This demo data can later be erased using module Defenix HMS Data Cleaner which comes pre-installed with this installation.',
		'Country' => 'Country',
		...
		'I agree to receive the Newsletter and promotional offers from Defenix HMS.' => 'I agree to receive the Newsletter and promotional offers from Defenix HMS.',
		...
		'To use Defenix HMS, you must <a href="%1$s" target="_blank">create a database</a> to collect all of your website\'s data-related activities.' => 'To use Defenix HMS, you must <a href="%1$s" target="_blank">create a database</a> to collect all of your website\'s data-related activities.',
		'Please complete the fields below in order for Defenix HMS to connect to your database. ' => 'Please complete the fields below in order for Defenix HMS to connect to your database.',
		...
		'Defenix HMS Installation Assistant' => 'Defenix HMS Installation Assistant',
		'Forum' => 'Forum',
		'Blog' => 'Blog',
		...
		'Tutorials' => 'Tutorials',
		'See our Defenix HMS tutorials' => 'See our Defenix HMS tutorials',
		'Installation Assistant' => 'Installation Assistant',
		'To install Defenix HMS, you need to have JavaScript enabled in your browser.' => 'To install Defenix HMS, you need to have JavaScript enabled in your browser.',
		...
		'Find just the right features on Defenix HMS Addons to make your hospitality business a success.' => 'Find just the right features on Defenix HMS Addons to make your hospitality business a success.',
		...
		'You have just finished installing Defenix HMS. Thank you for using Defenix HMS!' => 'You have just finished installing Defenix HMS. Thank you for using Defenix HMS!',
		...
		'I just built an online hotel booking website with Defenix HMS!' => 'I just built an online hotel booking website with Defenix HMS!',
		'See all the features here : https://docs.defenix.com/' => 'See all the features here : https://docs.defenix.com/',
		'Tweet' => 'Tweet',
		'Share' => 'Share',
		'Google+' => 'Google+',
		'Pinterest' => 'Pinterest',
		'LinkedIn' => 'LinkedIn',
		'We are currently checking Defenix HMS compatibility with your system environment' => 'We are currently checking Defenix HMS compatibility with your system environment',
		...
		'Defenix HMS compatibility with your system environment has been verified!' => 'Defenix HMS compatibility with your system environment has been verified!',
		...
		'Defenix HMS requires at least 128 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.' => 'Defenix HMS requires at least 128 MB of memory to run: please check the memory_limit directive in your php.ini file or contact your host provider about this.',
		'Welcome to the Defenix HMS %s Installer' => 'Welcome to the Defenix HMS %s Installer',
		'Installing Defenix HMS is quick and easy. In just a few moments, you will become part of a community. You are on the way to creating your own hotel booking website that you can manage easily every day.' => 'Installing Defenix HMS is quick and easy. In just a few moments, you will become part of a community. You are on the way to creating your own hotel booking website that you can manage easily every day.',
		...
		'The language selection above only applies to the Installation Assistant. Once Defenix HMS is installed, you can choose the language of your website from over %d translations, all for free!' => 'The language selection above only applies to the Installation Assistant. Once Defenix HMS is installed, you can choose the language of your website from over %d translations, all for free!',
	),
);